...
func desiredConfigMap(namespace string) *corev1.ConfigMap {
...
func desiredDeployment(namespace, image string) *appsv1.Deployment {
	labels := commonLabels()
...
func desiredConsolePlugin(namespace string) *consolev1.ConsolePlugin {
	return &consolev1.ConsolePlugin{
		...
		Spec: consolev1.ConsolePluginSpec{
			...
			I18n: consolev1.ConsolePluginI18n{
				LoadType: consolev1.PreloadType,
			},
			Backend: consolev1.ConsolePluginBackend{
				Type: consolev1.ServiceBackendType,
