...
func TestJibConfigMap(t *testing.T) {
	...
	err := CreateProfileConfigmap(ctx, c, "<profile>awesomeprofile</profile>",
		kit.Name, kit.Namespace, kit.APIVersion, kit.Kind, v1.IntegrationKitLabel, kit.Annotations, kit.UID)
	require.NoError(t, err)
