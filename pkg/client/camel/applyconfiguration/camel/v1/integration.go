...
type IntegrationApplyConfiguration struct {
	...
	*metav1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                                 *camelv1.IntegrationSpec             `json:"spec,omitempty"`
...
func (b *IntegrationApplyConfiguration) WithSpec(value camelv1.IntegrationSpec) *IntegrationApplyConfiguration {
	b.Spec = &value
	return b
}
