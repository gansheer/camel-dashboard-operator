...
type fakeApps struct {
	*gentype.FakeClientWithListAndApply[*v1alpha1.App, *v1alpha1.AppList, *camelv1alpha1.AppApplyConfiguration]
	Fake *FakeCamelV1alpha1
}

func newFakeApps(fake *FakeCamelV1alpha1, namespace string) typedcamelv1alpha1.AppInterface {
	return &fakeApps{
		gentype.NewFakeClientWithListAndApply[*v1alpha1.App, *v1alpha1.AppList, *camelv1alpha1.AppApplyConfiguration](
			fake.Fake,
			namespace,
